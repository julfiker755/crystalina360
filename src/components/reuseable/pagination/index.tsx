  ...
  return (
    <div className={cn("lg:w-[320px] flex justify-end", className)}>
      <ResponsivePagination
        previousLabel={<ChevronsLeft className="size-5 text-primary" />}
        nextLabel={<ChevronsRight className="size-5 text-primary" />}
        ...
        activeItemClassName={cn(
          `bg-transparent border-none text-figma-black bg-primary hover:!text-figma-black  hover:!bg-primary rounded-full`,
          activeStyle
        )}
