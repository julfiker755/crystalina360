                                    ...
                                    >
                                        ...
                                        <div className="p-3 space-y-2">
                                            ...
                                            {user?.email ? (
                                                ...
                                                <button className="flex items-center justify-center gap-2 w-full border border-border/40  text-[#4A3E37] py-2 rounded-lg text-xs font-bold  transition-colors">Sign in to access</button>
                                            )}
        ...
        <div className="fixed bottom-6 right-6 z-50">
            ...
            {!isChatOpen && (
                ...
                >
                    ...
                    <span className="font-bold text-sm hidden sm:block">Chat with AI</span>
                </button>
            )}
...
const WaveAnimation = () => {
    const DevElement = <div className={`flex items-center gap-0.5 opacity-100 transition-opacity duration-300`}>
