            ...
            <div className="space-y-4">
                ...
                <div className="space-y-5 mt-6">
                    <div className="lg:grid lg:grid-cols-2 gap-6 space-y-6 lg:space-y-0">
                        ...
                        <div className="lg:col-span-2">
                            <FromTagInput label="Your Skills" name="skills" />
                        </div>
                        <div className="mt-8 pt-8 border-t col-span-2 border-gray-100">
                            <h2 className="text-lg font-bold mb-3 text-figma-black">Preferences</h2>
