        ...
        <div className="max-w-7xl mx-auto p-8">
          <div className="grid grid-cols-2 gap-8">
            ...
            <div className="space-y-8">
              {/* Image Upload */}
              <div className="border-2 border-dashed border-gray-300 rounded-lg p-12 flex flex-col items-center justify-center min-h-64 bg-gray-50">
              ...
              <div>
                ...
                <div className="flex gap-3">
                  {[
                    ...
                    { id: "ondemand", label: "On demand", icon: "📱" },
                  ].map((type) => (
                    <button
                      key={type.id}
